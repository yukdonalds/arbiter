# -----------------------------
# Fast Paper Trader – IBKR connection (copy from mission, uses local config)
# Account and all values in USD.
# -----------------------------
import random
...
def get_position_size(ib: IB, account_id: str, ticker: str) -> float:
    """Return current long position size for ticker (0 if flat or short)."""
